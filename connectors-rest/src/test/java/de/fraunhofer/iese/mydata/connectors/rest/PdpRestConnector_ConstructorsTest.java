...
/**
 * The Class PdpRestConnector_ConstructorsTest.
 */
public class PdpRestConnector_ConstructorsTest {
   ...
   */
  @Test
  public void testConstructorAndUrisNULL() throws RemoteException {
    assertThrows(NullPointerException.class, () -> {
      new PdpRestConnector((String) null);
    });
  }
   ...
   */
  @Test
  public void testConstructorAndUrisWrongFormat() throws RemoteException {
    assertThrows(IllegalArgumentException.class, () -> {
      new PdpRestConnector("demo:demo://demo:demo");
    });
  }
  ...
  public void testConstructorAndUrisAsString() {
    try {
      final PdpRestConnector connector = new PdpRestConnector(Constants.BASE_URL);
      this.assertValues(connector);
    } catch (final Exception e) {
      Assertions.fail("Exception has been thrown. Error in PdpRestConnector(string): " + e.getMessage());
    }
  }
  ...
  public void testConstructorAndUrisAsUri() {
    try {
      ...
      final PdpRestConnector connector = new PdpRestConnector(uri);
      this.assertValues(connector);
    } catch (final Exception e) {
      Assertions.fail("Exception has been thrown. Error in PdpRestConnector(string): " + e.getMessage());
    }
  ...
  public void testConstructorAndUrisPlain() {
    try {
      final PdpRestConnector connector = new PdpRestConnector(Constants.SCHEME, Constants.HOST, Constants.PORT, Constants.NAME);
      this.assertValues(connector);
    } catch (final Exception e) {
      Assertions.fail("Exception has been thrown. Error in PdpRestConnector(string): " + e.getMessage());
    }
   ...
   */
  private void assertValues(PdpRestConnector connector) {
    ...
    assertThat((Integer)getInternalState(connector, "port"), equalTo(Constants.PORT));
  }
