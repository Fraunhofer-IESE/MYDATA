...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
  ...
  /**
   * The label to subtype.
   */
  private final Map<String, Class<?>> labelToSubtype = new LinkedHashMap<>();

  /**
   * The subtype to label.
   */
  private final Map<Class<?>, String> subtypeToLabel = new LinkedHashMap<>();

  /**
   * Instantiates a new runtime type adapter factory.
   *
  ...
  public <R> TypeAdapter<R> create(Gson gson, TypeToken<R> type) {
    ...
    return new TypeAdapter<R>() {
      ...
      public void write(JsonWriter out, R value) throws IOException {
        ...
        final String label = RuntimeTypeAdapterFactory.this.subtypeToLabel.get(srcType);
        @SuppressWarnings("unchecked") // registration requires that subtype
                                       // extends T
