...
@Getter
@Setter
@MyDataComponentInformation(componentType = ComponentType.PDP)
public class PdpComponentInformation extends MyDataEntity {
   ...
   */
  protected PdpComponentInformation() {
    // required by JPA
  }

  /**
   * Constructs a {@link PdpComponentInformation} without URLs or ComponentInterface.
   *
   * @param componentId the unique ID of the {@link PdpComponentInformation}.
   */
  public PdpComponentInformation(ComponentId componentId) {
    this(componentId, new ArrayList<>());
  }

  /**
   * Constructs a {@link PdpComponentInformation}, including its location ( {@link URI}) and its
   * usage ({@link MethodInterfaceDescription}).
   *
   * @param id   the unique ID of the {@link PdpComponentInformation}
   * @param urls a list of {@link URI}s that can be used to communicate with the
   *               {@link PdpComponentInformation}
   */
  public PdpComponentInformation(ComponentId id, List<URI> urls) {
    this.componentId = id;
    this.urls = urls;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof PdpComponentInformation)) {
      return false;
    }

    final PdpComponentInformation that = (PdpComponentInformation) o;
