...
public class TestPipHttpConnector implements IPolicyInformationPoint {

  public TestPipHttpConnector(URI uri) {

  }

  @Override
  public DataObject<?> evaluate(final PipRequest pipRequest)
