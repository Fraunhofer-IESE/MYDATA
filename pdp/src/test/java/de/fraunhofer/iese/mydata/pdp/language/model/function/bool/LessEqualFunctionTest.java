...
/**
 * The Class LessEqualFunctionTest.
 */
public class LessEqualFunctionTest {
  public Evaluation evaluation;

  /**
   * Less equal function basic tests.
   *
  ...
  @ParameterizedTest(name = "lessEqual {0}")
  public void lessEqualFunctionBasicTests(Evaluation evaluation)
      throws EvaluationUndecidableException {

    this.initLessEqualFunctionTest(evaluation);

    if (evaluation.expectedException != null) {
      assertThrows(evaluation.expectedException, () -> {

        final BooleanFunction function = new LessEqualFunction();
  ...
  public void initLessEqualFunctionTest(Evaluation evaluation) {
