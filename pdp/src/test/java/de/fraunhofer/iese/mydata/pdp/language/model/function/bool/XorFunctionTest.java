...
public class XorFunctionTest {
  ...
  public void andOperatorBasicTests(Evaluation evaluation) throws EvaluationUndecidableException {
    ...
    this.initXorFunctionTest(evaluation);

    if (evaluation.expectedException != null) {
      assertThrows(evaluation.expectedException, () -> {

        final XorFunction operator = new XorFunction();
    ...
    return Arrays.asList(new Object[][] {
        {
            ...
            new Evaluation(true, true, true, true, false)
        }, {
            new Evaluation(true, false, false, false, true)
        }, {
  ...
  public void initXorFunctionTest(Evaluation evaluation) {
