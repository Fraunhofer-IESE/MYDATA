...
/**
 * The Class EqualsFunctionTest.
 */
public class EqualsFunctionTest {
  public Evaluation evaluation;

  /**
   * Equals function basic tests.
   *
  ...
  public void equalsFunctionBasicTests(Evaluation evaluation)
      throws EvaluationUndecidableException {

    this.initEqualsFunctionTest(evaluation);

    if (evaluation.expectedException != null) {
      assertThrows(evaluation.expectedException, () -> {

        final EqualsFunction function = new EqualsFunction();
  ...
  public static Collection<Object[]> data() {
    ...
    final URI uri2 = URI.create("http://localhost:8080");
    ...
    return Arrays.asList(new Object[][] {
        {
            ...
            new Evaluation(true, 3, 3.0)
        }, {
            new Evaluation(false, 8, 7, 6, 4, 4, 3, 3, 1, 0.4)
        }, {
            new Evaluation(IllegalArgumentException.class, 8)
        }, {
            new Evaluation(true, Integer.MAX_VALUE, Integer.MAX_VALUE)
        }, {
            new Evaluation(true, new Double(Integer.MAX_VALUE) * new Double(Integer.MAX_VALUE),
                4611686014132420609l)
        }, {
            new Evaluation(true, "bla", "bla")
        }, {
            new Evaluation(false, "2", 2)
        }, {
            new Evaluation(true, uri, uri)
        }, {
            new Evaluation(false, uri, uri2)
        }
    });
  }

  public void initEqualsFunctionTest(Evaluation evaluation) {
