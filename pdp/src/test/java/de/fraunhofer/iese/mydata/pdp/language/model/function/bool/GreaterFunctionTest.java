...
/**
 * The Class GreaterFunctionTest.
 */
public class GreaterFunctionTest {
  public Evaluation evaluation;

  /**
   * Greater function basic tests.
   *
  ...
  @ParameterizedTest(name = "greater {0}")
  public void greaterFunctionBasicTests(Evaluation evaluation)
      throws EvaluationUndecidableException {

    this.initGreaterFunctionTest(evaluation);

    if (evaluation.expectedException != null) {
      assertThrows(evaluation.expectedException, () -> {

        final GreaterFunction function = new GreaterFunction();
    ...
    return Arrays.asList(new Object[][] {
        {
            ...
            new Evaluation(true, Integer.MAX_VALUE, Integer.MIN_VALUE)
        }, {
  ...
  public void initGreaterFunctionTest(Evaluation evaluation) {
