...
/**
 * The Class LessFunction.
 */
public class LessFunction extends ArithmeticFunction {
  /**
   * The logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(LessFunction.class);

  /**
   * Instantiates a new less function.
   */
  public LessFunction() {
    super();
  }
