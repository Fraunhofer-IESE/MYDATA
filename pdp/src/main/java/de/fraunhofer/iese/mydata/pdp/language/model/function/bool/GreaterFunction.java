...
/**
 * The Class GreaterFunction.
 */
public class GreaterFunction extends ArithmeticFunction {
  /**
   * The logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(GreaterFunction.class);
