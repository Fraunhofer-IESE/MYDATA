...
/**
 * The Class LessEqualFunction.
 */
public class LessEqualFunction extends ArithmeticFunction {
  /**
   * The logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(LessEqualFunction.class);

  /**
   * Instantiates a new less equal function.
   */
