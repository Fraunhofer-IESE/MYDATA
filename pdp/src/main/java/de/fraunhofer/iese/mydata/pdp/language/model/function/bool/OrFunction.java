 ...
 */
@XmlRootElement(namespace = "http://www.mydata-control.de/4.0/mydataLanguage", name = "or")
public class OrFunction extends Function {
  ...
  public DataObject<Boolean> evaluate(Event evt) throws EvaluationUndecidableException {
    if (this.getParameters() == null || this.getParameters().isEmpty()) {
      throw new EvaluationUndecidableException("Cannot evaluate less than one argument for OR");
    }
