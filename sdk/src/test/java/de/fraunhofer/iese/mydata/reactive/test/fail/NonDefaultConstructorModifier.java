...
public class NonDefaultConstructorModifier implements ModifierMethod {

  @Override
  public DocumentContext doModification(DocumentContext documentContext, String s, ParameterList parameterList) {
    return null;
  }
