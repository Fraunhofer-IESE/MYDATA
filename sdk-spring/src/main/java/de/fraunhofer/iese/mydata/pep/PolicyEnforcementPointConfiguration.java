...
public class PolicyEnforcementPointConfiguration {
  ...
  @Bean
  static PepServiceBeanDefinitionRegistryPostProcessor pepServiceBeanDefinitionRegistryPostProcessor() {
    return new PepServiceBeanDefinitionRegistryPostProcessor(new PepCandidateComponentProvider());
  }
